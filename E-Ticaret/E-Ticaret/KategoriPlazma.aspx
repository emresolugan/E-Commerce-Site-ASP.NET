<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KategoriPlazma.aspx.cs" Inherits="E_Ticaret.KategoriPlazma" %>
...
<div class="cnt-main btm">
	<div class="section group">
			<asp:DataList ID="DataList1" runat="server" RepeatColumns="3" BackColor="White" BorderColor="#ffffff" BorderStyle="Solid" BorderWidth="1px" CellPadding="4" DataSourceID="SqlDataSource1" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" GridLines="Horizontal" Height="221px" Width="765px" >
                ...
                <ItemTemplate>
                 <div class="divürün">
                    ...
                    <asp:Image ID="Image1" CssClass="img" ImageUrl='<%# Eval("Resim") %>' runat="server" />
                    <br />
                 <br />
			...
			<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ETticaretConnectionString %>" SelectCommand="SELECT [Ad], [Fiyat], [Resim] FROM [ürün] WHERE ([KategoriID] = @KategoriID)">
                <SelectParameters>
                    <asp:QueryStringParameter DefaultValue="" Name="KategoriID" QueryStringField="4" Type="Int32" />
                </SelectParameters>
            </asp:SqlDataSource>
                    <div class="clear"></div>
				 </div>
