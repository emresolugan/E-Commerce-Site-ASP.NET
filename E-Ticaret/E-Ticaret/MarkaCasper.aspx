<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MarkaCasper.aspx.cs" Inherits="E_Ticaret.MarkaCasper" %>
...
<div class="cnt-main btm">
	<div class="section group">
					 ...
					 <asp:DataList ID="DataList1" runat="server" RepeatColumns="3" BackColor="White" BorderColor="White" BorderStyle="Solid" BorderWidth="1px" CellPadding="4" DataSourceID="SqlDataSource2" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" GridLines="Horizontal" Height="221px" Width="707px" >
